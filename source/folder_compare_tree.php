...
if (isset($_POST['submit'])) {
    ...
    foreach ($files1_only as $file) {
        ...
        echo '<li>
            ...
            . ltrim((string) $file, '/')
            . ' [<a href="' . action_link('file/info', ['path' => $full_path]) . '">1</a>]
        </li>';
    }
    ...
    foreach ($files2_only as $file) {
        ...
        echo '<li>
            <span class="bull">&bull;</span> '
            . ltrim((string) $file, '/')
            . ' [<a href="' . action_link('file/info', ['path' => $full_path]) . '">2</a>]
        </li>';
    }
    ...
    foreach ($files_intersect_final as $file) {
        ...
        echo '<li>
            <span class="bull">&bull;</span> '
            . ltrim((string) $file, '/')
            . ' [<a href="' . acttion_link('file/info', ['path' => $full_path1]) . '">1</a>]'
            . ' [<a href="' . acttion_link('file/info', ['path' => $full_path2]) . '">2</a>]
        </li>';
    }
